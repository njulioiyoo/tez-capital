...
<template>
    <Head title="Welcome - Tez Capital Hot Reload Test">
        <link rel="preconnect" href="https://rsms.me/" />
        <link rel="stylesheet" href="https://rsms.me/inter/inter.css" />
    </Head>
    <div class="flex min-h-screen flex-col items-center bg-red-500 p-6 text-white lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
